...
class Task:
    ...
    done: bool = False  # completion state that mark_done() flips
...
class Scheduler:
    ...
    def generate_plan(self) -> list[Task]:
        """Greedily choose tasks by priority that fit the time budget and don't
        double-book a preferred_time slot. Stores and returns the plan."""
        plan: list[Task] = []
        used_minutes = 0
